...
namespace Backup_algoritmus.Algorithm
{
    ...
    public class SnapshotFTP
    {
        ...
        public SnapshotFTP(List<Source> sources, string path, int retentioncount)
        {
        ...
        public SnapshotFTP(List<Source> sources, string path, int retentioncount, int packagescount, string type, Destination searchedfolder)
        {
            //DIFF
            this.Sources = sources;
            this.LogDataDest = path;
        ...
        public SnapshotFTP(List<Source> sources, string path, int retentioncount, int packagescount, string type, List<Destination> searchedfolder)
        {
            //INCR
            this.Sources = sources;
            this.LogDataDest = path;
